...
class Sms extends BaseModel
{
    ...
    public static $fields_type = [
        ['name'=>'短信登录','exp_time'=>600,'content'=>'登录验证码为:{verify},有效期:{exp_time}分钟,请尽快使用'],
        ['name'=>'忘记密码','exp_time'=>600,'content'=>'验证码:{verify},有效期:{exp_time}分钟,请尽快使用'],
        ['name'=>'用户注册','exp_time'=>600,'content'=>'注册验证码为:{verify},有效期:{exp_time}分钟,请尽快使用'],
    ];

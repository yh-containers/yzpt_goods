...
class Member extends Common
{
    ...
    public function orderlist(){
        ...
        $order_list = $order_model->field('id,no,money,pay_time,cancel_time,complete_time,send_start_time,receive_start_time,create_time,step_flow,status,is_send,is_receive')->with('ownGoods')->where($sql_where)->order('create_time desc')->paginate();

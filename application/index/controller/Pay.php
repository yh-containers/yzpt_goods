        ...
        try{
            if(strpos($_SERVER['HTTP_USER_AGENT'],'MicroMessenger')){
                if(empty(session('openid'))){
                    $url = 'https://open.weixin.qq.com/connect/oauth2/authorize?appid='.\app\common\service\third\OpenWx::config('mobile','app_id').'&redirect_uri='.urlencode(url('index/thirdlogin',['mode'=>'wechat','mobile'=>1],false,true)).'&response_type=code&scope=
